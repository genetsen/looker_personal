view: prisma_porcessed {
  sql_table_name: `20250327_data_model.prisma_porcessed` ;;
  ...
  dimension: channel_if_buy_category {
    type: string
    sql: ${TABLE}.channel_if_buy_category ;;
  }
  ...
  dimension: placement_type_site {
    type: string
    sql: ${TABLE}.placement_type_site ;;
  }
