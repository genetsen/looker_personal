...
| --- | --- | --- |
| Source workbook | Reads `Report` for visible delivery values and `Import` for supporting ad-group IDs. | The workbook is still titled "APO Search Data Template" upstream. |
