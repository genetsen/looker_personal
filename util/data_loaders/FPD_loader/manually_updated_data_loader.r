...
# Configuration
sheet_id <- "1kUD8gVrHAAaZbULtFgDZl1hgGU-7Ut8fSdNJDgsZwfE"
output_dir <- "/Users/eugenetsenter/Looker_clonedRepo/looker_personal/util/data_loaders/FPD_loader/MUD_output"
bq_project <- "looker-studio-pro-452620"
bq_dataset <- "landing"
bq_table <- "manually_updated_fpd_daily"
...
# Save summary
summary_file <- file.path(output_dir, "manually_updated_fpd_package_summary.csv")
