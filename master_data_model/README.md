...
- [Planned direct CM360 conversion migration](docs/rtl-direct-cm360-conversion-migration.md) - direct-source design and QA candidate for RTL conversions, including a full-outer detail output that retains conversion-only evidence. The current Sheet-based production path is unchanged.
...
- [Ritual conversion report](https://console.cloud.google.com/bigquery?project=looker-studio-pro-452620&p=looker-studio-pro-452620&d=landing&t=rtl_conv_report&page=table) - placeholder digital conversion outcome source used by v3. It carries package/date/site/creative/activity conversion rows and Sheet lineage.
