-- Corrected v2 delivery detail model.
--
-- Purpose:
...
CREATE OR REPLACE VIEW `looker-studio-pro-452620.master_stg.data_model_delivery_detail_v2` AS
WITH
...
SELECT
  ...
  CASE
    WHEN UPPER(COALESCE(pc.`_advertiser_short_name`, pm.advertiser_short_name, '')) = 'APO'
      OR UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')) = 'APO'
      OR REGEXP_CONTAINS(UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')), r'APOLLO') THEN 'Apollo'
    WHEN UPPER(COALESCE(pc.`_advertiser_short_name`, pm.advertiser_short_name, '')) = 'OLI'
      OR UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')) = 'OLI'
      OR REGEXP_CONTAINS(UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')), r'OLIPOP') THEN 'Olipop'
    WHEN UPPER(COALESCE(pc.`_advertiser_short_name`, pm.advertiser_short_name, '')) = 'MASS'
      OR UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')) = 'MASS'
      OR REGEXP_CONTAINS(UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')), r'MASSMUTUAL') THEN 'MassMutual'
    WHEN UPPER(COALESCE(pc.`_advertiser_short_name`, pm.advertiser_short_name, '')) = 'FMUS'
      OR REGEXP_CONTAINS(UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')), r'(ADIF|DIAMOND|FOREVERMARK|DE BEERS)') THEN 'A Diamond Is Forever'
    WHEN UPPER(COALESCE(pc.`_advertiser_short_name`, pm.advertiser_short_name, '')) = 'GEA'
      OR UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')) = 'GEA'
      OR REGEXP_CONTAINS(UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')), r'GE AEROSPACE') THEN 'GE Aerospace'
    WHEN UPPER(COALESCE(pc.`_advertiser_short_name`, pm.advertiser_short_name, '')) = 'RTL'
      OR UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')) = 'RTL'
      OR REGEXP_CONTAINS(UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')), r'RITUAL') THEN 'Ritual'
    WHEN UPPER(COALESCE(pc.`_advertiser_short_name`, pm.advertiser_short_name, '')) = 'ICE'
      OR UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')) = 'ICE'
      OR REGEXP_CONTAINS(UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')), r'INTERCONTINENTAL EXCHANGE') THEN 'ICE'
    WHEN UPPER(COALESCE(pc.`_advertiser_short_name`, pm.advertiser_short_name, '')) = 'ADSK'
      OR UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')) = 'ADSK'
      OR REGEXP_CONTAINS(UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')), r'AUTODESK') THEN 'Autodesk'
    WHEN UPPER(COALESCE(pc.`_advertiser_short_name`, pm.advertiser_short_name, '')) = 'ITR'
      OR REGEXP_CONTAINS(UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')), r'CUMBERLAND') THEN 'Cumberland Packing'
    WHEN UPPER(COALESCE(pc.`_advertiser_short_name`, pm.advertiser_short_name, '')) = 'NBC'
      OR REGEXP_CONTAINS(UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')), r'NBC') THEN 'NBC Entertainment'
    WHEN UPPER(COALESCE(pc.`_advertiser_short_name`, pm.advertiser_short_name, '')) = 'SYNC'
      OR REGEXP_CONTAINS(UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')), r'SYNCHRONY') THEN 'Synchrony'
    WHEN REGEXP_CONTAINS(UPPER(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name, '')), r'HIGHLIGHTS') THEN 'Highlights'
    ELSE COALESCE(
      NULLIF(TRIM(COALESCE(pc.`_advertiser_name`, pm.advertiser_name, d.source_advertiser_name)), ''),
      NULLIF(TRIM(COALESCE(pc.`_advertiser_short_name`, pm.advertiser_short_name)), ''),
      'Unknown'
    )
  END AS `_advertiser`,
